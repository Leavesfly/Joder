package io.leavesfly.joder.services.reminder;

import io.leavesfly.joder.domain.ReminderCategory;
import io.leavesfly.joder.domain.ReminderMessage;
import io.leavesfly.joder.domain.ReminderPriority;
...
class SystemReminderServiceTest {
    ...
    void testSecurityReminder() {
        ...
        Assertions.assertEquals(ReminderCategory.SECURITY, securityReminder.getCategory());
        Assertions.assertEquals(ReminderPriority.HIGH, securityReminder.getPriority());
