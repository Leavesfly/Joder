package io.shareai.joder.core;

import io.shareai.joder.domain.Message;
import io.shareai.joder.domain.MessageRole;
import io.shareai.joder.services.context.ContextCompressor;
import io.shareai.joder.services.memory.ProjectMemoryManager;
import io.shareai.joder.services.model.MockModelAdapter;
...
class MainLoopTest {
    ...
    void testProcessUserInput() {
        ...
        assertEquals(MessageRole.ASSISTANT, response.getRole(), "Response role should be ASSISTANT");
