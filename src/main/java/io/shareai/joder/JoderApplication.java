...
@Command(
    ...
    version = "Joder 1.0.0",
    description = "AI-Powered Terminal Assistant - Java implementation of Kode"
)
public class JoderApplication implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        try {
            ...
            io.shareai.joder.screens.ReplScreen replScreen = injector.getInstance(io.shareai.joder.screens.ReplScreen.class);
            replScreen.start();
