...
public class AgentsCommand implements Command {
    ...
    private CommandResult listAgents() {
        ...
        // 按类型分组
        List<AgentConfig> builtinAgents = agentsManager.getAgentsByType(AgentType.BUILTIN);
        List<AgentConfig> userAgents = agentsManager.getAgentsByType(AgentType.USER);
        List<AgentConfig> projectAgents = agentsManager.getAgentsByType(AgentType.PROJECT);
